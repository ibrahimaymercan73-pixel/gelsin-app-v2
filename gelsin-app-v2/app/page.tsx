              ...
              return (
                <motion.div key={c.slug} variants={itemUp} className="flex">
                  <Link
                    ...
                    className="flex-1 min-w-[160px] p-6 rounded-2xl bg-white border border-slate-100 shadow-sm hover:shadow-md hover:-translate-y-1 hover:border-slate-200 transition-all duration-200 active:scale-[0.98] text-center group"
                  >
